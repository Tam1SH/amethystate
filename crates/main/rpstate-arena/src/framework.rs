...
pub trait Backend: rpstate::Store {}
#[cfg(not(target_arch = "wasm32"))]
impl<T: rpstate::Store> Backend for T {}

#[cfg(target_arch = "wasm32")]
pub trait Backend: rpstate::client::AsyncSubscriptionBackend {}
#[cfg(target_arch = "wasm32")]
impl<T: rpstate::client::AsyncSubscriptionBackend> Backend for T {}
...
pub trait RpStateFrameworkNested {
    type Handle: Copy + Send + Sync + 'static;
    fn register(&self, arena: &DefaultArena) -> Self::Handle;
}

#[cfg(not(target_arch = "wasm32"))]
pub trait RpStateFramework<B: ReactiveBackend>:
    rpstate::RpStateSlice<B::Storage> + RpStateFrameworkNested
{
}

#[cfg(not(target_arch = "wasm32"))]
impl<B: ReactiveBackend, T: rpstate::RpStateSlice<B::Storage> + RpStateFrameworkNested>
    RpStateFramework<B> for T
{
}

#[cfg(target_arch = "wasm32")]
pub trait RpStateFramework<B: ReactiveBackend>:
    rpstate::client::RpStateSliceAsync<B::Storage> + RpStateFrameworkNested
{
}

#[cfg(target_arch = "wasm32")]
impl<B: ReactiveBackend, T: rpstate::client::RpStateSliceAsync<B::Storage> + RpStateFrameworkNested>
    RpStateFramework<B> for T
{
}
